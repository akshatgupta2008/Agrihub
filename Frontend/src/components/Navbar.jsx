...
const Navbar = () => {
  ...
  const loginBtnClass = (isSelected) =>
    isSelected
      ? "px-4 py-2 rounded-full bg-gradient-to-r from-primary to-secondary text-white text-sm font-semibold shadow-md hover:shadow-lg transition-all"
      : "px-4 py-2 rounded-full border border-slate-300 text-slate-600 text-sm font-medium hover:bg-slate-50 hover:border-primary-light hover:text-primary-dark transition-all";
